		...
		$(function(){
			$.ajax({
				...
				$.each(data,function(i,v){
					$('#divCarousel').append('<div class="item"><a href="product.php?pid='+v['idProdotto']+'&promo=1"><div class="carousel-caption"><h3>'+v['nome']+'</h3><p>'+v['prezzo']+' &euro;</p></div><img src="media/product_images/'+v['src']+'" alt="'+v['nome']+'"></a></div>');
