...
?>
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h1 class="text-center">Smart life - offerte per te</h1>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="wrapper">
                        ...
                        <div class="thumbnail sl-offerta">
                            <p>
                                <img class="media-object" src="http://placehold.it/200x150" align="left" alt="First">
                            <h4 class="media-heading">Tim trasporti</h4>
                            Lorem Ipsum è un testo segnaposto utilizzato nel settore della tipografia e della
                            stampa. Lorem Ipsum è considerato il testo segnaposto standard sin dal sedicesimo
                            secolo, quando un anonimo tipografo prese una cassetta di caratteri e li assemblò
                            per preparare un testo campione. È sopravvissuto non solo a più di cinque secoli, ma
                ...
                <div class="col-sm-6 col-md-4">
                    ...
                    <div class="thumbnail sl-offerta">
                        <p>
                            <img class="media-object" src="http://placehold.it/200x150" align="left" alt="First">
                        <h4 class="media-heading">Scopri nuove storie</h4>
                        Lorem Ipsum è un testo segnaposto utilizzato nel settore della tipografia e della
                        stampa. Lorem Ipsum è considerato il testo segnaposto standard sin dal sedicesimo
                        secolo, quando un anonimo tipografo prese una cassetta di caratteri e li assemblò
                        per preparare un testo campione. È sopravvissuto non solo a più di cinque secoli, ma
