        ...
        <div class="col-xs-12">
            <div class="sl-navigation">
                <ul class="nav nav-pills">
                    <li role="presentation" class="active"><a href="#">Descrizione</a></li>
                    <li role="presentation"><a href="#">Attivazione e regolamento</a></li>
                    <li role="presentation"><a href="#">FAQ</a></li>
                    <li role="presentation"><a href="#">Dispositivi</a></li>
                </ul>
            </div>
        </div>
    </div>
