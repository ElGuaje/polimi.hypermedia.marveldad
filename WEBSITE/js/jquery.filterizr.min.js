!function (t, i) {
    ...
    r.prototype = {
        init: function (t) {
            ...
            var i, r, e, n = t.length, o = n > 0 ? t[0].h : 0;
        ...
        init: function (t, r) {
            ...
            return e.options = {
                ...
                padding: 0,
                position: "relative"
            }), e._lastCategory = 0, e._isAnimating = !1, e._isShuffling = !1, e._isSorting = !1, e._mainArray = e._getFiltrItems(), e._subArrays = e._makeSubarrays(),
                e._activeArray = e._getCollectionByFilter(e.options.filter),
                e._toggledCategories = {}, e._typedText = i("input[data-search]").val() || "", e._uID = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (t) {
                var i = 16 * Math.random() | 0, r = "x" == t ? i : 3 & i | 8;
            ...
            var i = this, r = i._multifilterModeOn() ? i._makeMultifilterArray() : i._getCollectionByFilter(i.options.filter), e = [], n = 0;
            if (i._isSearchActivated())for (n = 0; n < r.length; n++) {
                var o = r[n].text().toLowerCase().indexOf(t.toLowerCase()) > -1;
                o && e.push(r[n])
            }
            if (e.length > 0)i._handleFiltering(e); else if (i._isSearchActivated())for (n = 0; n < i._activeArray.length; n++)i._activeArray[n]._filterOut(); else i._handleFiltering(r)
        }, shuffle: function () {
            var t = this;
            ...
            if (e)for (var n = 0; n < r._mainArray.length; n++)r._mainArray[n][t] = r._mainArray[n].data(t);
            ...
            var t = this, r = i(t.find(".filtr-item")), n = [];
            ...
            for (r = 0; r < t._mainArray.length; r++)if ("object" == typeof t._mainArray[r]._category)for (var e = t._mainArray[r]._category.length, n = 0; e > n; n++)i[t._mainArray[r]._category[n] - 1].push(t._mainArray[r]); else i[t._mainArray[r]._category - 1].push(t._mainArray[r]);
            return i
        }, _makeMultifilterArray: function () {
            for (var t = this, i = [], r = {}, e = 0; e < t._mainArray.length; e++) {
                var n = t._mainArray[e], o = !1, a = n.domIndex in r == !1;
            ...
            if ("packed" === t.options.layout) {
                ...
                for (h.fit(t._activeArray), c = 0; c < e.length; c++)posArray.push({left: e[c].fit.x, top: e[c].fit.y});
                n = h.root.h
            }
            if ("horizontal" === t.options.layout)for (a = 1, c = 1; c <= e.length; c++)s = e[c - 1].outerWidth(), l = e[c - 1].outerHeight(), posArray.push({
                left: f,
                top: u
            }), f += s, l > n && (n = l); else if ("vertical" === t.options.layout) {
                for (c = 1; c <= e.length; c++)l = e[c - 1].outerHeight(), posArray.push({left: f, top: u}), u += l;
                n = u
                ...
                for (c = 1; c <= e.length; c++) {
                    s = e[c - 1].width();
                    var p = e[c - 1].outerWidth(), y = 0;
                    e[c] && (y = e[c].width()), posArray.push({
                        left: f,
                        top: u
                ...
                for (c = 1; c <= e.length; c++) {
                    if (posArray.push({
                            left: f,
                            top: u
                        }), c % o === 0 && a++, f += s, u = 0, a > 0)for (g = a; g > 0;)u += e[c - o * g].outerHeight(), g--;
                    c % o === 0 && (f = 0)
                }
                for (c = 0; o > c; c++) {
            ...
            var i = this;
            // Testing if t is an array
            if (t.constructor === Array) {
                var result = [];
                var iter = 0;
                t.forEach(function (index, item) {
                    if (iter == 0) {
                        result = $.merge([], i._subArrays[index - 1]);
                        iter++;
                    } else {
                        result = $(result).filter(i._subArrays[index - 1]);
                    }
                });
                return result;
    ...
    var e = {
        _init: function (t, i) {
            ...
            i.transform += " translate3d(" + t._lastPos.left + "px," + t._lastPos.top + "px, 0)",
                t.css(i), t.css("pointer-events", "none"),
                t._filteringOut = !0
