...
--
-- Host: localhost
-- Generation Time: Lug 11, 2016 alle 13:09
...
(2, 'iPhone 5s 16GB', 479.9, 'bellissimo telefono!', 'funziona benissimo!', 'Apple', 1, 1, 'Display 4 pollici', 'iOS 10', 'Solo 112 grammi', 'It''s an iPhone!', '', NULL, NULL, NULL, NULL),
(3, 'Sony XPERIA X', 629.9, 'bellissimo telefono!', 'funziona benissimo!', 'Sony', 1, 0, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL),
(4, 'Huawei P9', 599.9, 'bellissimo telefono!', 'funziona benissimo!', 'Huawei', 1, 1, 'Display 5.2 pollici', 'Memoria 32GB espandibile', 'Processore 2.2GHz', 'Fotocamera 12Mpx', '', NULL, NULL, NULL, NULL),
(5, 'Decoder TIM Vision', 89.99, 'Decoder timvision', NULL, 'TIM', 4, 0, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL);
