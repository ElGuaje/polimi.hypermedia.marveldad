!function (t, i) {
    ...
    r.prototype = {
        ...
        init: function (t, r) {
            ...
            if ("horizontal" === t.options.layout)for (a = 1, c = 1; c <= e.length; c++)s = e[c - 1].outerWidth(), l = e[c - 1].outerHeight(), _.push({
                left: f,
                top: u
    ...
    var e = {
        _init: function (t, i) {
            ...
            var r = this, e = r._parent._makeDeepCopy(r._parent.options.filterInCss);
